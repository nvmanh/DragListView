...
public class DragItem {
    ...
    public void onMeasureDragView(View clickedView, View dragView) {
        dragView.setLayoutParams(new FrameLayout.LayoutParams(clickedView.getMeasuredWidth(),
                clickedView.getMeasuredHeight()));
        int widthSpec = View.MeasureSpec.makeMeasureSpec(clickedView.getMeasuredWidth(),
                View.MeasureSpec.EXACTLY);
        int heightSpec = View.MeasureSpec.makeMeasureSpec(clickedView.getMeasuredHeight(),
                View.MeasureSpec.EXACTLY);
    ...
    void startDrag(View startFromView, float touchX, float touchY) {
        ...
        if (mSnapToTouch) {
            ...
            PropertyValuesHolder pvhX =
                    PropertyValuesHolder.ofFloat("AnimationDx", mAnimationDx, 0);
            PropertyValuesHolder pvhY =
                    PropertyValuesHolder.ofFloat("AnimationDY", mAnimationDy, 0);
    ...
    public void scale(boolean isScaled) {
        ScaleUtil.scaleViewAndChildren(mDragView, ScaleUtil.getScale(isScaled), 0);
    }
}
